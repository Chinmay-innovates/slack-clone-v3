...
export const Huddle = ({ isModalOpen, setIsModalOpen }: HuddleProps) => {
  ...
  switch (true) {
    case callingState === CallingState.RINGING && call.isCreatedByMe && call.id === channel.id:
    default:
      return null;
    case callingState === CallingState.JOINED || callingState === CallingState.JOINING:
      return <HuddleUI isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} isSidebar />;
