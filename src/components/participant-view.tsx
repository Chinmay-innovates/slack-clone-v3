...
import { Keep, MicrophoneOff, MoreVert } from './icons';
...
export const ParticipantViewUI = () => {
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          isSpeaking && hasAudioTrack && 'ring-[3px] ring-[#fff] shadow-[0_0_8px_5px_#fff]',
      ...
      <div
        ...
        className={clsx('z-[999] absolute top-2 right-2', showMenu ? 'opacity-100' : 'opacity-0')}
      >
